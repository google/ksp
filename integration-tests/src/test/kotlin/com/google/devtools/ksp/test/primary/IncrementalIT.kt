...
class IncrementalIT(experimentalPsiResolution: Boolean) {
    ...
    val src2DirtyKSP2 =
        listOf(
            "workload/src/main/java/p1/J1.java" to
                setOf(
                    "w: [ksp] p1/TestK2J.kt",
                    "w: [ksp] p1/TestJ2J.java",
                    "w: [ksp] p1/J1.java",
                ),
            "workload/src/main/java/p1/J2.java" to
                setOf(
                    "w: [ksp] p1/TestK2J.kt",
                    "w: [ksp] p1/J2.java",
                ),
            "workload/src/main/java/p1/TestJ2J.java" to setOf("w: [ksp] p1/TestJ2J.java"),
            "workload/src/main/java/p1/TestJ2K.java" to setOf("w: [ksp] p1/TestJ2K.java"),
            "workload/src/main/java/p2/J2.java" to
                setOf(
                    "w: [ksp] p1/TestK2J.kt",
                    "w: [ksp] p2/J2.java",
                    "w: [ksp] p1/TestJ2J.java",
                ),
            "workload/src/main/java/p3/J1.java" to
                setOf(
                    "w: [ksp] p1/TestK2J.kt",
                    "w: [ksp] p3/J1.java",
                ),
            "workload/src/main/java/p3/J2.java" to
                setOf(
                    "w: [ksp] p1/TestK2J.kt",
                    "w: [ksp] p3/J2.java",
                ),
            "workload/src/main/java/p3/J3.java" to
                setOf(
                    "w: [ksp] p1/TestK2J.kt",
                    "w: [ksp] p1/TestJ2J.java",
                    "w: [ksp] p3/J3.java",
                ),
            "workload/src/main/kotlin/p1/K1.kt" to
                setOf(
                    "w: [ksp] p1/TestK2K.kt",
                    "w: [ksp] p1/K1.kt",
                    "w: [ksp] p1/TestJ2K.java",
                ),
            "workload/src/main/kotlin/p1/K2.kt" to
                setOf(
                    "w: [ksp] p1/TestK2K.kt",
                    "w: [ksp] p1/K2.kt",
                ),
            "workload/src/main/kotlin/p1/TestK2J.kt" to setOf("w: [ksp] p1/TestK2J.kt"),
            "workload/src/main/kotlin/p1/TestK2K.kt" to setOf("w: [ksp] p1/TestK2K.kt"),
            "workload/src/main/kotlin/p2/K2.kt" to
                setOf(
                    "w: [ksp] p1/TestK2K.kt",
                    "w: [ksp] p2/K2.kt",
                    "w: [ksp] p1/TestJ2K.java",
                ),
            "workload/src/main/kotlin/p3/K1.kt" to
                setOf(
                    "w: [ksp] p1/TestK2K.kt",
                    "w: [ksp] p3/K1.kt",
                ),
            "workload/src/main/kotlin/p3/K2.kt" to
                setOf(
                    "w: [ksp] p1/TestK2K.kt",
                    "w: [ksp] p3/K2.kt",
                ),
            "workload/src/main/kotlin/p3/K3.kt" to
                setOf(
                    "w: [ksp] p1/TestK2K.kt",
                    "w: [ksp] p3/K3.kt",
                    "w: [ksp] p1/TestJ2K.java",
    ...
    fun testIsolating() {
        ...
        val cleanArtifact =
            Artifact(File(project.root, "workload/build/libs/workload-1.0-SNAPSHOT.jar"))
    ...
    fun testMultipleChanges() {
        ...
        changeSets.forEach { changeSet ->
            ...
            val expectedDirties =
                changeSet.flatMapTo(mutableSetOf()) {
                    src2Dirty[it].second
                }
            gradleRunner.withArguments("assemble").build().let { result ->
                Assert.assertEquals(
    ...
    fun testProcessorChange() {
        ...
        gradleRunner.withArguments("build").build().let { result ->
            ...
            Assert.assertEquals(
                ...
                result.task(":workload:kspTestKotlin")?.outcome,
            )
        }
        val cleanArtifact =
            Artifact(File(project.root, "workload/build/libs/workload-1.0-SNAPSHOT.jar"))
