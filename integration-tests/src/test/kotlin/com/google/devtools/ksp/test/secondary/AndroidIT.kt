        ...
        gradleRunner
            ...
            .let { result ->
                ...
                JarFile(classesJar).use { jarFile ->
                    ...
                    jarFile.assertContainsNonNullEntry(
                        "META-INF/proguard/builder-AClassBuilder.pro"
                    )
                    jarFile.assertContainsNonNullEntry(
                        "META-INF/proguard/builder-BClassBuilder.pro"
                    )
                }
                ...
                assert(
                    "w: [ksp] [workload_debug] Mangled name for internalFun: internalFun\$workload_debug" in
                        outputs
                )
                assert(
                    "w: [ksp] [workload_release] Mangled name for internalFun: internalFun\$workload_release" in
                        outputs
                )
            }
    }
