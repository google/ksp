...
class BuildCacheIT(experimentalPsiResolution: Boolean) {
    @Rule
    @JvmField
    val project1: TemporaryTestProject =
    ...
    @Rule
    @JvmField
    val project2: TemporaryTestProject =
        TemporaryTestProject(
            "buildcache",
            "playground",
            experimentalPsiResolution = experimentalPsiResolution,
