    ...
    companion object {
        ...
        fun data(): Collection<Arguments> {
            return listOf(
                ...
                // Alpha/beta versions
                Arguments.of("8.10.0-alpha03", "2.2.10", "8.11.1"),
                Arguments.of("8.10.0-alpha03", "2.3.0-RC", "8.11.1"),
                Arguments.of("8.12.0-alpha06", "2.2.10", "8.13"),
                Arguments.of("8.12.0-alpha06", "2.3.0-RC", "8.13"),
                Arguments.of("9.0.0-alpha12", "2.2.10", "9.1.0"),
                Arguments.of("9.0.0-alpha12", "2.3.0-RC", "9.1.0"),
                Arguments.of("9.0.0-alpha14", "2.2.10", "9.1.0"),
                Arguments.of("9.0.0-alpha14", "2.3.0-RC", "9.1.0"),

                // AGP 8.7.0
                Arguments.of("8.7.0", "2.3.0-RC", "8.11.1"),
                Arguments.of("8.7.0", "2.2.10", "8.11.1"),
                // AGP 8.8.0
                Arguments.of("8.8.0", "2.3.0-RC", "8.11.1"),
                Arguments.of("8.8.0", "2.2.10", "8.11.1"),
                // AGP 8.9.0
                Arguments.of("8.9.0", "2.3.0-RC", "8.11.1"),
                Arguments.of("8.9.0", "2.2.10", "8.11.1"),
                // AGP 8.10.0
                Arguments.of("8.10.0", "2.3.0-RC", "8.11.1"),
                Arguments.of("8.10.0", "2.2.10", "8.11.1"),
                // AGP 8.11.0
                Arguments.of("8.11.0", "2.3.0-RC", "8.13"),
                Arguments.of("8.11.0", "2.2.10", "8.13"),
                // AGP 8.12.0
                Arguments.of("8.12.0", "2.3.0-RC", "8.13"),
                Arguments.of("8.12.0", "2.2.10", "8.13"),
                // AGP 9.0.0-beta01
