...
class KSWhenExpressionImpl private constructor(ktWhenExpression: KtWhenExpression) : KSWhenExpression,
    ...
    class Branch private constructor(val ktWhenEntry: KtWhenEntry) : KSWhenExpression.Branch {
        ...
        override val conditions: Array<KSExpression> by lazy {
            ktWhenEntry.conditions.map2Array {
                when(it) {
        ...
        override fun toString(): String = ktWhenEntry.text


        open class Condition(val ktWhenCondition: KtWhenCondition) : KSExpression {
