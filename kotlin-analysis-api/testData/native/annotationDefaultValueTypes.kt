...
// NOTE: This test is a duplicate of the non-native annotationDefaultValueTypes to assert that both JVM and native return the same results.
...
// The remaining parameters cover the conversions of `FirAnnotationValueConverter`.
