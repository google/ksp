...
/**
 * This is a helper class for [PsiResolutionStrategy] which supports upcoming language features.
 * The shape of [PsiResolutionNext] is intentionally kept very similar to that of [PsiResolutionStrategy] to allow
 * easy merging of the two classes.
 *
 * It is intentional that it does **not** implement [AnnotationResolutionStrategy], since it should only
 * be used in a specific scenario where [PsiResolutionStrategy] calls it.
 */
class PsiResolutionNext(
    ...
    fun getSymbolsWithAnnotation(annotationName: String): Sequence<KSAnnotated> =
        ...
        throw InternalKSPException(
            "Unexpected unreachable function call. " +
                "PsiResolutionNext.getSymbolsWithAnnotation($annotationName) should not be called. " +
